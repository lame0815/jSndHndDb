...
public class JSndHndDbApp {

    private static final Logger log = LoggerFactory.getLogger(JSndHndDbApp.class);

    private final Environment env;

    public JSndHndDbApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jSndHndDb.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JSndHndDbApp.class);
